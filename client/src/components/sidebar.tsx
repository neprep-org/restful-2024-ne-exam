...
const SideBar = () => {
  ...
  return (
    <div className="h-[100%] w-[30%]  hidden sm:visible sm:w-[22%] md:[19%] lg:w-[200px] border-r border-primary sm:flex sm:flex-col sm:justify-between p-4 bg-primary shadow-lg shadow-primary-dark fixed ">
      <div>
